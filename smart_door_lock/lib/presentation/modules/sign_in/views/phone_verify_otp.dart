...
import '../controllers/phone_verify_otp_controller.dart';

class PhoneOtp extends GetView<PhoneVerifyOtpController> {
                  ...
                  children: [
                    Flexible(
                      child: Text(
                        ...
                        style: const TextStyle(color: Color(0xFF666A74), fontSize: 12),
